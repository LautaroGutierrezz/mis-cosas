...
function personajes() {
  ...
  translate(-950, 0);
  imageMode(CENTER);
  image(cazadores[(frameCount/12|0)%8], contador*5.2, 320, 190, 190);
  image(cazadores[(frameCount/12|0)%8], contador*5.5, 360, 200, 200);
  image(cazadores[(frameCount/12|0)%8], contador*5.6, 450, 200, 200);
  image(cazadores[(frameCount/12|0)%8], contador*5.4, 500, 200, 200);
  pop();
...
function salir() {
  contador++;
//use scale que al ponerle los valores x e y me invierten la imagen como espejo (en este caso horizonalmente) y tuve que usar un push/pop por cada jinete ya que manejaban distintos rangos de velocidad,al igual que un translate para que empezaran desde más atras
  push();
  imageMode(CENTER);
  translate(800- contador*6, 400); // posición de arranque
  scale(-1, 1);                       // espeja la cara vertical
  image(cazador[(frameCount/6|0)%10], 0, 0, 200, 200);
  pop();

  push();
  imageMode(CENTER);
  translate(1750 - contador*5.2, 320);
  scale(-1, 1);
  image(cazadores[(frameCount/12|0)%8], 0, 0, 190, 190);
  pop();

  push();
  imageMode(CENTER);
  translate(1750- contador*5.5, 360);
  scale(-1, 1);
  ...
  push();
  imageMode(CENTER);
  translate(1750 - contador*5.6, 450);
  scale(-1, 1);
  image(cazadores[(frameCount/12|0)%8], 0, 0, 200, 200);
  pop();
  ...
  push();
  imageMode(CENTER);
  translate(1750 - contador*5.4, 500);
  scale(-1, 1);
  image(cazadores[(frameCount/12|0)%8], 0, 0, 200, 200);
  pop();
